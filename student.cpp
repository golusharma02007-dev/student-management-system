...
void enter() {
    int ch;
    cout << "Number of students to whom you want to enter data: ";
    cin >> ch;
    if (total == 0) {
        total = total + ch;
        for (int i = 0; i < ch; i++) {
            cout << "\nEnter Data of student " << i + 1 << endl;
            cout << "Enter Name: "; cin >> arr1[i];
            cout << "Enter Roll no: "; cin >> arr2[i];
            cout << "Enter Course: "; cin >> arr3[i];
            cout << "Enter Class: "; cin >> arr4[i];
            cout << "Enter Contact: "; cin >> arr5[i];
        }
    } else {
